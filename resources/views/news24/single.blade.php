            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="{{ route('single', ['id' => $post->id]) }}">Single <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item ">
...
<div id="fh5co-title-box" style="background-image: url( {{ asset('post/'.$post->image) }} ); background-position: 50% 90.5px;" data-stellar-background-ratio="0.5">
